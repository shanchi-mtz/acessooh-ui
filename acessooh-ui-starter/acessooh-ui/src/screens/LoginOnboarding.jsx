    ...
    <div className="min-h-screen flex">
      {!loggedIn ? (
        <div className="flex w-full">
          <div className="hidden md:flex w-1/2 bg-cover bg-center" style={{backgroundImage: "url('https://img.freepik.com/free-photo/coffe-shop-with-wooden-walls-unfocused_1203-1229.jpg')"}} />
        ...
        <div className="w-full flex flex-col p-10 space-y-8">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div onClick={onContinue} className="card p-6 hover:bg-gray-700 cursor-pointer text-center">
              <div className="text-yellow-400 text-lg font-semibold">Novo Projeto</div>
            </div>
            <div className="card p-6 hover:bg-gray-700 cursor-pointer text-center">
